...
const Ejemplo2 = () => {
    ...
    // con un elemento del DOM del componente (vista HTML) ESTA EN EL H4 DEL RETURN
    const miRef = useRef();
     ...
     * CAMBIA EN LA PANTALLA PERO NO EN LA CONSOLA
     */
   ...
   //  }, [contador1]);
     ...
     * O SEA QUE LIMITA A ESOS DOS LISTADOS PERO NADA MAS
     */
     useEffect(() => {
